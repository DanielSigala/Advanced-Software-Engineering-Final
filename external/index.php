               ...
               <div class="row">
                    ...
                    <div class="col-md-4 col-sm-4">
                         <div class="feature-thumb">
                             ...
                             <a href="add_equipment.php" class="btn btn-default smoothScroll">Discover more</a>
                         </div>
                    </div>
				   <div class="col-md-4 col-sm-4">
                         <div class="feature-thumb">
                              <h3>Modify Equipment</h3>
                              <p>Click here to modify equipment</p>
                             <a href="modify_equipment.php" class="btn btn-default smoothScroll">Discover more</a>
                         </div>
                    </div>
