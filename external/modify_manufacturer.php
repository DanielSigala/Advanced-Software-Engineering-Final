...
<head>
    <meta charset="utf-8">
    <title>Modify Manufacturer Details</title>
...
<body id="top" data-spy="scroll" data-target=".navbar-collapse" data-offset="50">
    <section class="navbar custom-navbar navbar-fixed-top" role="navigation">
        <div class="container">
            <div class="navbar-header">
                ...
                <a href="#" class="navbar-brand">Modify Manufacturer Details</a>
            </div>
    ...
    <section id="feature" class="container">
        <div class="row">
            <h2>Modify Manufacturer Details</h2>
            <?php
            function fetchManufacturers() {//get list of manufacturers from list_manufacturers.php api using curl
                $url = "https://ec2-3-142-142-169.us-east-2.compute.amazonaws.com:8080/api/list_manufacturers.php";
                $ch = curl_init();
			...
			//get list of manufacturers for dropdown menu from fetchManufacturers function
            $manufacturersResponse = fetchManufacturers();
            $manufacturers = isset($manufacturersResponse['Data']) ? $manufacturersResponse['Data'] : [];

            if ($_SERVER['REQUEST_METHOD'] === 'POST') {//send data from fields to modify_manufacturer.php api
                ...
                $url = "https://ec2-3-142-142-169.us-east-2.compute.amazonaws.com:8080/api/modify_manufacturer.php";
                $ch = curl_init($url);
            ...
            <form action="" method="post">
                <div class="form-group">
                    <label for="current_name">Current Manufacturer Name:</label>
                    <select class="form-control" id="current_name" name="current_name">
                        <?php foreach ($manufacturers as $manufacturer) {
                            echo '<option value="' . htmlspecialchars($manufacturer['manufacturer_name']) . '">' . htmlspecialchars($manufacturer['manufacturer_name']) . '</option>';
                        } ?>
                    </select>
                </div>
                <div class="form-group">
                    <label for="new_name">New Manufacturer Name:</label>
